...
class JordiLlonchCrudFosUserCommand extends GenerateDoctrineCrudCommand
{
    protected $generator;
    ...
    protected function configure()
    {
        ...
        $this->setName('jordillonch:generate:crudFosUser');
        $this->setDescription('A CRUD generator with paginating and filters with FosUserBundle.');
    }
  ...
  protected function getGenerator()
    {
        ...
        if (null === $this->generator) {
            if (file_exists($myResdir.'/Resources/JordiLlonchCrudGeneratorBundle/skeletonFosUser/crud')) {
                $this->generator = new DoctrineCrudGenerator($this->getContainer()->get('filesystem'), $myResdir.'/Resources/JordiLlonchCrudGeneratorBundle/skeletonFosUser/crud');
            }else{
                $this->generator = new DoctrineCrudGenerator($this->getContainer()->get('filesystem'), __DIR__.'/../Resources/skeletonFosUser/crud');
            }
    ...
    protected function getFormGenerator()
    {
        if (null === $this->formGenerator) {
            $this->formGenerator = new DoctrineFormGenerator($this->getContainer()->get('filesystem'),  __DIR__.'/../Resources/skeletonFosUser/form');
        }
    ...
    protected function getFormFilterGenerator()
    {
        if (null === $this->formFilterGenerator) {
            $this->formFilterGenerator = new DoctrineFormFilterGenerator($this->getContainer()->get('filesystem'),  __DIR__.'/../Resources/skeletonFosUser/form');
        }
